  ...
  <nav class="bg-white border-gray-200 dark:bg-gray-900">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
        <img src="src/images/DALL·E 2024-09-22 23.56.17 - A modern, sleek logo for a website with the theme 'Data Analytics'. The logo should include graphical elements like bar charts, pie charts, or data vi.webp" class="h-8" alt="Flowbite Logo" />
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Data Analytics</span>
      </a>
      <button
      ...
      <div class={`w-full md:block md:w-auto ${isMenuOpen ? '' : 'hidden'}`} id="navbar-default">
